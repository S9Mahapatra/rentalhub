...
// The mongoose singleton is cached on `global` to survive Next.js hot reloads,
// which means a model registered by an earlier compile keeps its old schema and
// silently shadows any edit made here. Re-register in development so schema
// changes take effect without a full server restart.
