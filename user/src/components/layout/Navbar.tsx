...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/20 backdrop-blur-2xl  ">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link 
            href="/products" 
            className="text-xs font-bold text-neutral-600 hover:text-neutral-650 transition-colors uppercase tracking-wider"
          >
            Catalog
          </Link>
          <Link 
            href="/stores" 
            className="text-xs font-bold text-neutral-600 hover:text-neutral-650 transition-colors uppercase tracking-wider flex items-center gap-1.5"
          >
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <Link
            href="/profile"
            className="flex items-center gap-2 px-3.5 py-2 rounded-full text-xs font-semibold text-neutral-700 hover:bg-neutral-100 transition-all border border-neutral-500/80"
          >
